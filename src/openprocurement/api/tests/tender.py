...
class TenderResourceTest(BaseWebTest):
    ...
    def test_create_tender_invalid(self):
        ...
        data = test_tender_data['value']
        test_tender_data['value'] = {'valueAddedTaxPercentage': 20, 'amount': 100.0, "currency": "UAH"}
        response = self.app.post_json(request_path, {'data': test_tender_data}, status=422)
        test_tender_data['value'] = data
        self.assertEqual(response.status, '422 Unprocessable Entity')
        self.assertEqual(response.content_type, 'application/json')
        self.assertEqual(response.json['status'], 'error')
        self.assertEqual(
        ...
        data = test_tender_data['value']
        test_tender_data['value'] = {'valueAddedTaxPercentage': 0, 'amount': 100.0, "currency": "UAH"}
        response = self.app.post_json(request_path, {'data': test_tender_data}, status=422)
        test_tender_data['value'] = data
        self.assertEqual(response.status, '422 Unprocessable Entity')
        self.assertEqual(response.content_type, 'application/json')
        ...
        data = test_tender_data['value']
        test_tender_data['value'] = {'valueAddedTaxPercentage': '', 'amount': 100.0, "currency": "UAH"}
        response = self.app.post_json(request_path, {'data': test_tender_data}, status=422)
        test_tender_data['value'] = data
        self.assertEqual(response.status, '422 Unprocessable Entity')
        self.assertEqual(response.content_type, 'application/json')
        ...
        data = test_tender_data['minimalStep']
        test_tender_data['minimalStep'] = {'valueAddedTaxPercentage': 20, 'amount': 100.0}
        response = self.app.post_json(request_path, {'data': test_tender_data}, status=422)
        test_tender_data['minimalStep'] = data
        self.assertEqual(response.status, '422 Unprocessable Entity')
        self.assertEqual(response.content_type, 'application/json')
        ...
        data = test_tender_data['minimalStep']
        test_tender_data['minimalStep'] = {'valueAddedTaxPercentage': 0, 'amount': 100.0}
        response = self.app.post_json(request_path, {'data': test_tender_data}, status=422)
        test_tender_data['minimalStep'] = data
        self.assertEqual(response.status, '422 Unprocessable Entity')
        self.assertEqual(response.content_type, 'application/json')
        ...
        data = test_tender_data['minimalStep']
        test_tender_data['minimalStep'] = {'valueAddedTaxPercentage': '', 'amount': 100.0}
        response = self.app.post_json(request_path, {'data': test_tender_data}, status=422)
        test_tender_data['minimalStep'] = data
        self.assertEqual(response.status, '422 Unprocessable Entity')
        self.assertEqual(response.content_type, 'application/json')
    ...
    def test_tender_item_location_validation(self):
        ...
        response = self.app.patch_json('/tenders/' + tender_id, {
...
class TenderProcessTest(BaseTenderWebTest):
    ...
    def test_one_invalid_bid_tender(self):
        ...
        response = self.app.post_json(
            '/tenders/{}/bids'.format(tender_id), {
                'data': {'tenderers': [test_organization], "value": {"amount": 500, "valueAddedTaxPercentage": 0}}
            }
        )
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(response.content_type, 'application/json')
    ...
    def test_first_bid_tender(self):
        ...
        response = self.app.post_json(
            '/tenders/{}/bids'.format(tender_id), {
                'data': {'tenderers': [test_organization], "value": {"amount": 450, "valueAddedTaxPercentage": 20}}
            }
        )
        ...
        response = self.app.post_json(
            '/tenders/{}/bids'.format(tender_id), {
                'data': {'tenderers': [test_organization], "value": {"amount": 475, "valueAddedTaxPercentage": 0}}
            }
        )
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(response.content_type, 'application/json')
        data = response.json['data']
        self.assertEqual(data['value']['amount'], 475)
        self.assertEqual(data['value']['valueAddedTaxPercentage'], 0)
